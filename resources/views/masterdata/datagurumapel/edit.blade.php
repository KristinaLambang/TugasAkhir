...
<div class="section">
    ...
    <div class="form-group">
      <div class="row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="nama_guru_mapel" name="nama_guru_mapel" placeholder="Nama Guru Mata Pelajaran" required>
            </div>
    </div>
    </div>
    ...
    <div class="form-group">
      <div class="row">
        <div class="col-sm-2">
           ...
           <div class="col-sm-10">
              <select name="nama_mapel" class="form-control" id="id_mapel" required>
